module.exports = {
  head: {
    ...
    meta: [
      ...
      { hid: 'og:url', property: 'og:url', content: 'https://kazukiotao.com/' },
      ...
      { hid: 'og:image', property: 'og:image', content: 'https://kazukiotao.com/works/img/jumbotron5.jpg' },
      { name: 'twitter:card', content: 'summary' },
      { name: 'twitter:site', content: '@0meo' },
      { name: 'twitter:title', content: '大峠和基 / Kazuki Otao' },
      { name: 'twitter:url', content: 'https://kazukiotao.com/' },
      { name: 'twitter:image', content: 'https://kazukiotao.com/works/img/jumbotron5.jpg' },
