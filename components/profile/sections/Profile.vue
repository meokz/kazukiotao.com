...
const profile = {
  jp: "1996年広島生まれ．筑波大学大学院卒．学生時代からリサーチエンジニアとしてスタートアップ企業の研究論文の執筆と特許の出願に関わる．その後、YouTube向け動画を自動生成するAIを開発しサービス化して起業．それらの業績が評価され、経済産業省所轄の情報処理推進機構より，未踏事業スーパクリエータ認定及び未踏アドバンスド事業イノベータ認定を受ける．",
